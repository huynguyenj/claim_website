...
function LoginForm() {
 ...
 <Form
  ...
  >
    ...
    <FormItem>
    <h1 className='text-[1.2rem] mt-5 sm:text-3xl font-bold text-center'>Login</h1>
    </FormItem>
    <Form.Item<UserForm>
      name="userName"
    ...
    >
      ...
      <Button type="primary" style={{height:'2.5rem'}}><UserIcon/></Button>
    ...
    >
       <Space.Compact style={{ width: '100%' }}>
      <Button type="primary" style={{height:'2.5rem'}}><PasswordIcon/></Button>
      <Input.Password placeholder='password' />
    </Space.Compact>
    </Form.Item>

    <Form.Item className='h-10'>
      <Button type="primary" htmlType="submit" className='w-full' style={{padding:'1.2rem',borderRadius:'2rem'}}>
        Login
      </Button>
    </Form.Item>
    <FormItem>
        <p className='text-[0.7rem] sm:text-[1rem]'>You not have an account?<span className='text-blue-500 cursor-pointer font-bold hover:underline ml-1' onClick={handleChangePage}>Sign up</span></p>
    </FormItem>

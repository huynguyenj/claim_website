...
<<<<<<< HEAD
      ...
      return (
            <aside
                  className={`bg-black/100 h-screen ${isOpen ? "w-50" : "w-22"
            ...
            >
                  <nav className="flex flex-col ">
                        <div className="w-full flex rounded-full mt-13 gap-3 items-center px-5">
                              ...
                              />
                              <p
                                    className={`text-white font-bold text-[0.9rem] sm:text-[1.2rem] ${!isOpen && "hidden"
                                          }`}
                              >
                                    System
                              </p>
                                    ...
                                    <li key={item.title}>
                                          {item.path ? (
                                                <Link
                                                      ...
                                                      className={`flex gap-x-5 p-2 rounded-2xl items-center hover:bg-indigo-500 duration-300 ease-in-out ${item.gap && "mb-10"
                                                            } relative`}
                                                >
                                                      <div>
                                                      ...
                                                      <span
                                                            className={`text-[0.8rem] sm:text-[1.1rem] ${!isOpen && "hidden"
                                                ...
                                                <div
                                                      className={`flex gap-5 p-2 rounded-2xl items-center hover:bg-indigo-500 duration-300 ease-in-out ${item.gap && "mb-10"
                                                            } relative`}
                                                      onClick={item.action}
                                                >
                                                      <div>

            ...
            >
                  <nav className="flex flex-col ">
                        <div className="w-full flex rounded-full mt-13 gap-3 items-center px-5">
                              ...
                              />
                              <p
                                    className={`text-white font-bold text-[0.9rem] sm:text-[1.2rem] overflow-hidden ${!isOpen && "hidden"
                                          }`}
                              >
                                    System
                              </p>
                              ...
                              {itemList.map((item) => (
                                    <li key={item.title}>
                                          <Link
                                                ...
                                                className={`flex gap-x-5 p-2 rounded-2xl items-center hover:bg-indigo-500 duration-500 ease-in-out ${item.gap && "mb-8"
                                                      } relative`}
                                          >
                                                <div>

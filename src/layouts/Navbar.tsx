  ...
  return (
    <nav className="mb-5 p-2 w-full sm:w-full">
      <div className="flex items-center w-full py-5 gap-5 justify-between sm:px-10">
            <div className=""><h1 className="text-[0.9rem] sm:text-[2rem] text-gray-500 font-bold">Welcome! {userInfo.userName}</h1></div>
            <div className="flex items-center gap-5 ">
                  ...
                  <div className="">
                        ...
                        {isPopup ? 
                        ( 
                              <Popup width="50rem" bg_color="#9fd3c7" top={20} right={10} padding_x={10} padding_y={5} content={anouncement} />
                        )
                        :(<></>)}
